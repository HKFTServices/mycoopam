        ...
        <div className="py-1">
          ...
          {step === "review" && (
            <ReviewStep
              ...
              totalFee={isSwitch ? switchFeeCalc.totalFee : isStockDeposit ? (stockDepositFees.totalFee + effectiveCourierFeeDeposit) : isStockWithdrawal ? (stockWithdrawalFees.totalFee + effectiveCourierFeeWithdrawal) : feeCalculation.totalFee}
              transactionDate={transactionDate}
