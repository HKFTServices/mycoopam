...
-- Function to get loan outstanding per entity from CFT legacy mappings
-- Components: 1962 (Payout), 1980 (Total Loan incl loading), 1978 (Instalments), 2002 (Write-offs)
-- Outstanding = Total Loan (1980) - Instalments (1978) - Write-offs (2002)
...
-- Function to get loan transaction detail for a specific entity
...
AS $$
  ...
  ORDER BY (lm.notes::json->>'TransactionDate') ASC, lm.legacy_id ASC;
$$;
