...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { data: tenantConfig } = await adminClient
      ...
      .select("smtp_host, smtp_port, smtp_username, smtp_password, smtp_from_email, smtp_from_name, smtp_enable_ssl, email_signature_en, email_signature_af, legal_entity_id, approval_cc_email, use_global_email_settings")
